...
mysqli_query($conn, $req);
$req = "CREATE TABLE command (command_id INT NOT NULL AUTO_INCREMENT , fk_user_id INT NOT NULL , fk_prod_id INT NOT NULL , nb_prod INT NOT NULL DEFAULT 1 , PRIMARY KEY (`command_id`) , FOREIGN KEY (fk_user_id) REFERENCES user(user_id) , FOREIGN KEY (fk_prod_id) REFERENCES prod(prod_id))";
mysqli_query($conn, $req);
